...
export default function TvDisplayCard({ item, index }: TvDisplayCardProps) {
  // Refactored for better adaptability on various screen sizes and older browser engines.
  // Using 'rem' based font sizes from Tailwind for scalability and truncating long text.
  return (
    <div
